...
export default function ProfilePanel({ profile, onUpdate }: Props) {
  ...
  return (
    <div className="profile-panel-inner">
      ...
      <ProfileSection title="Work Experience" renderEditor={editor('experience', profile.experience)}>
        <ExperienceList experience={profile.experience} />
      </ProfileSection>
      <ProfileSection title="Projects & Activities" renderEditor={editor('activities', profile.activities || [])}>
