...
## Home
- Users should be able to get an overview of all information contained by haid-hunter on a single page
    - Banner of your profile and key points (summary, skills, etc)
    - Document count (and breakdown by type)
    - Application Statistics
        - Total Applications
        - Applications by State
        - Total Referrals
            - Should expand to list everyone that has provided a referral
    - To-Do (Daily)
        - Apply for 5 positions
        - Update application statuses
        - Allow for user defined tasks (recurring and single-use)


## Settings Page (TO-DO)

## Resume Generation Page (TO-DO)